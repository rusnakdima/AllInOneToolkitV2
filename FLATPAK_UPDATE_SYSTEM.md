# Flatpak Update System for AllInOneToolkitV2

This document explains how the Flatpak update system works with the AllInOneToolkitV2 application and how to manage version updates.

## Overview

The AllInOneToolkitV2 application can be distributed as a Flatpak package with automatic update capabilities. The update system works in two layers:
...
- `flatpak/com.tcs.allinonetoolkitv2.metainfo.xml` - App metadata with release history
...
flatpak update com.tcs.allinonetoolkitv2

# Check for updates
flatpak remote-info flathub com.tcs.allinonetoolkitv2
```
...
The `com.tcs.allinonetoolkitv2.metainfo.xml` file contains:
