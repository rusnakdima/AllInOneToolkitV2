...
MANIFEST_FILE="com.tcs.allinonetoolkitv2.yml"
BUILD_DIR="build-dir"
REPO_DIR="repo"

echo "Building Flatpak for AllInOneToolkitV2..."
...
# Install runtime and SDK for GNOME 48
echo "Installing GNOME Platform and SDK version 48..."
flatpak install --user --noninteractive flathub org.gnome.Platform//48 2>/dev/null || echo "✓ Platform already installed"
flatpak install --user --noninteractive flathub org.gnome.Sdk//48 2>/dev/null || echo "✓ SDK already installed"
...
flatpak build-bundle $REPO_DIR allinonetoolkitv2.flatpak com.tcs.allinonetoolkitv2

echo ""
echo "✅ Build completed successfully!"
echo ""
echo "Generated file: allinonetoolkitv2.flatpak"
echo ""
echo "To install the Flatpak, run:"
echo "  flatpak install --user allinonetoolkitv2.flatpak"
echo ""
echo "To run the app:"
echo "  flatpak run com.tcs.allinonetoolkitv2"
