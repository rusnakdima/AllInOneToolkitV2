# AllInOneToolkitV2 Flatpak Build

This directory contains the files needed to build AllInOneToolkitV2 as a Flatpak application.

## Files

- `com.tcs.allinonetoolkitv2.yml`: The Flatpak manifest file that defines how to build the application.
...
```bash
flatpak build-bundle build-dir allinonetoolkitv2.flatpak com.tcs.allinonetoolkitv2
```

To install and run:

```bash
flatpak install allinonetoolkitv2.flatpak
flatpak run com.tcs.allinonetoolkitv2
```
